...
const STATUSVIESTIT = {
    ...
    EI_LOYTYNYT: id => ({
        viesti: `Annetulla avaimella ${id} ei löytynyt tietoja`,
        statuskoodi: STATUSKOODIT.EI_LOYTYNYT,
        tyyppi: 'virhe'
    }),
    LISAYS_OK: id => ({
        viesti: `Tieto avaimella ${id} lisättiin`,
    ...
    JO_KAYTOSSA: id => ({
        viesti: `Perusavain ${id} oli jo käytössä`,
        statuskoodi: STATUSKOODIT.JO_KAYTOSSA,
        tyyppi: 'virhe'
    }),
    POISTO_OK: id => ({
        viesti: `Tieto avaimella ${id} poistettiin`,
    ...
    PAIVITYS_OK: id => ({
        viesti: `Tiedot avaimella ${id} päivitettiin`,
