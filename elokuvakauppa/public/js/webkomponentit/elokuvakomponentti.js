...
export class Elokuvakortti extends HTMLElement{
    ...
    constructor(){
        ...
        this.#numerokentta = this.shadow.getElementById('numero');
    ...
    set hinta(uusi){
        return this.setAttribute('hinta',uusi);
    }
    ...
    paivita(elokuva){
        this.numero=elokuva.id;
        this.hinta=elokuva.hinta;
    ...
    static get observedAttributes(){
        return ['numero','hinta','nimi','vuosi','ohjaaja','tyyppi','arvostelu','kuva'];
    }
    ...
    attributeChangedCallback(attribuutti,vanha,uusi){
        ...
        switch(attribuutti){
            case 'numero': this.#numerokentta.textContent=uusi; break;
