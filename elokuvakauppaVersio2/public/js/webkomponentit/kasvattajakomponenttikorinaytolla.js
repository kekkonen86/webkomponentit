...
template.innerHTML=`
    ...
    <div>
        ...
        <kori-naytto leveys="50"></kori-naytto>
...
export class KasvattajaNaytolla extends HTMLElement{
    #shadow;
    #laskuri;
    #input;
    #plus;
    ...
    constructor(){
        ...
        this.#naytto = this.#shadow.querySelector('kori-naytto');
        //käsittelijät
    ...
    connectedCallback(){
        ...
        this.#naytto.addEventListener('click',this.#lisaakoriin);
    }
    ...
    disconnectedCallback(){
        ...
        this.#naytto.removeEventListener('click', this.#lisaakoriin);
    }
...
try{
    customElements.define('kasvattaja-korinaytolla',KasvattajaNaytolla);
}
catch(virhe){
